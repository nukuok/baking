...
%% output
out_file_dir_parent = '/home/nukuok/Desktop/baking/script_for_new_data/result_20170122/';
...
for ii = 1:32
  ...
  for jj = length(As):-1:1
	...
	figure
	hold on
	plot(origin_A(4,:),origin_A(3,:),'gx','linewidth',2)
	plot(oYs, oXs, 'bx', 'linewidth', 3);
	plot(Ys,Xs,'r')
	plot(result(4), result(3), 'rx', 'linewidth', 1)
	plot(origin_A(4,1),origin_A(3,1),'blackv','linewidth',3)
